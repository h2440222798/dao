...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest) {
        ...
        long result = userService.userRegister(userAccount, userPassword, checkPassword, userName, userEmail);
     ...
     * @return 是否成功
     */
    @PostMapping("/update/my/constitution")
    public BaseResponse<Boolean> updateMyConstitution(@RequestParam Integer wood, @RequestParam Integer fire,
            @RequestParam Integer earth, @RequestParam Integer metal, @RequestParam Integer water,
            HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        boolean result = userService.updateConstitution(loginUser.getId(), wood, fire, earth, metal, water);
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR);
        return ResultUtils.success(true);
    }
}
