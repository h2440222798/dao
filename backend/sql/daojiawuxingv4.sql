/*
 ...
 MySQL - 8.0.x : Database - daojiawuxing
 全新前端适配版：v4

 导入建议：
 1. 使用 UTF-8 编码保存本文件
 2. 使用 mysql --default-character-set=utf8mb4 导入
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `daojiawuxing`
...
) ENGINE=InnoDB AUTO_INCREMENT=2044388697794584578 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户表';

insert into `user`
(`id`,`userAccount`,`userPassword`,`unionId`,`mpOpenId`,`userName`,`userAvatar`,`userEmail`,`userProfile`,`userRole`,`wood`,`fire`,`earth`,`metal`,`water`,`createTime`,`updateTime`,`isDelete`)
values
...
insert into `diary`
(`id`,`userId`,`title`,`content`,`images`,`tags`,`dietScore`,`energy`,`mood`,`sleep`,`digestion`,`practices`,`wisdomInsight`,`likes`,`isApproved`,`createTime`,`updateTime`,`isDelete`)
values
...
(`id`,`diaryId`,`userId`,`content`,`createTime`,`updateTime`,`isDelete`)
values
...
CREATE TABLE `wuxing_topic` (
  ...
  `topicKey` varchar(32) NOT NULL COMMENT 'wood/fire/earth/metal/water',
  `name` varchar(32) NOT NULL COMMENT '五行名称',
  `organ` varchar(32) NOT NULL COMMENT '对应脏腑',
  `season` varchar(32) NOT NULL COMMENT '对应季节',
  `color` varchar(32) NOT NULL COMMENT '展示色值',
...
CREATE TABLE `practice_module` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `type` varchar(32) NOT NULL COMMENT 'spirit/body/meditation/cognition',
  `name` varchar(64) NOT NULL COMMENT '模块名称',
  `title` varchar(128) NOT NULL COMMENT '主标题',
  `subtitle` varchar(255) DEFAULT NULL COMMENT '副标题',
  `icon` varchar(32) DEFAULT NULL COMMENT '图标字符',
  `color` varchar(32) DEFAULT NULL COMMENT '主题色',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='修行模块表';

insert into `practice_module`
(`id`,`type`,`name`,`title`,`subtitle`,`icon`,`color`,`highlights`,`sort`,`createTime`,`updateTime`,`isDelete`)
values
...
CREATE TABLE `practice_content` (
  `id` varchar(64) NOT NULL COMMENT '前端内容 id',
  `type` varchar(32) NOT NULL COMMENT '模块类型',
  `title` varchar(128) NOT NULL COMMENT '标题',
  `wuxing` varchar(32) NOT NULL COMMENT '对应五行',
...
(`id`,`type`,`title`,`wuxing`,`duration`,`difficulty`,`summary`,`suitableCrowd`,`steps`,`tips`,`sort`,`createTime`,`updateTime`,`isDelete`)
values
...
CREATE TABLE `cognition_origin` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `originKey` varchar(32) NOT NULL COMMENT 'daoist/naval/munger/stoic',
  `title` varchar(128) NOT NULL COMMENT '标题',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='认知修行来源表';

insert into `cognition_origin`
(`id`,`originKey`,`title`,`source`,`color`,`summary`,`principles`,`practices`,`sort`,`createTime`,`updateTime`,`isDelete`)
values
...
CREATE TABLE `cognition_integration_step` (
  ...
  `isDelete` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='认知整合步骤表';

insert into `cognition_integration_step`
(`id`,`title`,`description`,`actions`,`sort`,`createTime`,`updateTime`,`isDelete`)
values
...
CREATE TABLE `cognition_routine` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `period` varchar(32) NOT NULL COMMENT '晨间/白天/夜间',
  `title` varchar(128) NOT NULL COMMENT '标题',
  ...
  `isDelete` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='认知修行节律表';

insert into `cognition_routine`
(`id`,`period`,`title`,`description`,`checklist`,`sort`,`createTime`,`updateTime`,`isDelete`)
values
...
CREATE TABLE `cognition_reading` (
  ...
  `isDelete` tinyint NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='认知修行阅读表';

insert into `cognition_reading`
(`id`,`title`,`author`,`focus`,`sort`,`createTime`,`updateTime`,`isDelete`)
values
...
CREATE TABLE `user_checkin` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `userId` bigint NOT NULL COMMENT '用户 id',
  `recordDate` varchar(32) NOT NULL COMMENT '打卡日期，兼容前端 zh-CN 日期格式',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户修行打卡表';

insert into `user_checkin`
(`id`,`userId`,`recordDate`,`dietDone`,`practiceDone`,`moodStable`,`restEnough`,`practiceTypes`,`sleepScore`,`moodScore`,`balanceScore`,`completedCount`,`note`,`createTime`,`updateTime`,`isDelete`)
values
